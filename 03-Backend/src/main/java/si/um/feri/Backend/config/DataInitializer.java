...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        taskRepository.saveAll(Arrays.asList(
                ...
                new Task("Prepare for Chemistry Quiz", "Study chapters 3 and 4 for", group1, TaskStatus.NOT_STARTED),
                ...
                new Task("Prepare Presentation for Client", "Create a PowerPoint presentation fo", group2, TaskStatus.NOT_STARTED),
                ...
                new Task("Write Blog Post on Travel Tips", "Research and write a 500-wor.", group3, TaskStatus.IN_PROGRESS),
                new Task("Create YouTube Video on Cooking", "Record and edit .", group3, TaskStatus.NOT_STARTED),
